import { ClinicalSummaryWrapper } from "../../components/wrapper/ClinicalSummaryWrapper"


export const ProgressNotesPage = () => {
    return (
        <ClinicalSummaryWrapper title="Progress Notes" >
            <div className="card">
