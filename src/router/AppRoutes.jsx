...
import { ScreeningPage } from "../pages/clinical/ScreeningPage";
import { OdontogramPage } from "../pages/clinical/odontogram/OdontogramPage";
import { PeriodentalPage } from "../pages/clinical/PeriodentalPage";
...
import { ProceduresPage } from "../pages/clinical/ProceduresPage";
...
const AppRoutes = () => {
    return (
        <Routes>
            ...
            {/* CLINICAL ROUTES */}
            <Route path="/clinical-screening" element={<ScreeningPage />} />
            <Route path="/clinical/odontogram" element={<OdontogramPage />} />
            <Route path="/clinical/periodental" element={<PeriodentalPage />} />
            <Route path="/clinical/progress-notes" element={<ProgressNotesPage />} />
            <Route path="/clinical/treatment-plan" element={<TreatmentPlanPage />} />
            <Route path="/clinical/procedures" element={<ProceduresPage />} />
